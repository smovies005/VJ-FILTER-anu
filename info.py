...
BOT_TOKEN = environ.get('BOT_TOKEN', "6691644015:AAEbSX3YXeKu_gKdAd81FHUd6qZtOKSr1jI")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dev:dev@cluster0.ni70udz.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "dev")
...
URL = "https://vj-filter-anu.pages.dev".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-anu.pages.dev/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vj-filter-anu.pages.dev".format(FQDN)
else:
    URL = "https://vj-filter-anu.pages.dev/".format(FQDN)

...
URL = "https://anusir-robot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://anusir-robot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://anusir-robot.onrender.com".format(FQDN)
else:
    URL = "https://anusir-robot.onrender.com/".format(FQDN)
